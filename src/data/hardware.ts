...
export const DATA_PLACAS: HardwareItem[] = [
  ...
  { 
    ...
    info: "Uma obra-prima da engenharia de semicondutores britânica, equipada com o chip RP2040 desenvolvido internamente pela Raspberry Pi. Sua característica 'lendária' reside no subsistema PIO (Programmable I/O), que permite aos desenvolvedores DEVGENIUS V12 criar máquinas de estado personalizadas para emular protocolos de hardware de ultra-velocidade que seriam impossíveis em outros microcontroladores. Com dois núcleos ARM Cortex-M0+ e suporte nativo a MicroPython/C++, o Pico redefine o custo-benefício em automação de precisão e controle de lógica síncrona.\n\nSua estrutura simplista porém poderosa suporta fontes de alimentação chaveadas integradas (SMPS), permitindo que receba de 1.8V a 5.5V, tornando-o perfeito para baterias AA ou carregadores de lítio. No ecossistema V12, ele é responsável por tarefas que exigem determinismo absoluto e baixíssima latência.",
...
export const DATA_COMPONENTES: HardwareItem[] = [
  { 
    ...
    info: "Uma matriz compacta de emissores semicondutores de Nitreto de Gálio (GaN) e Fosfeto de Índio e Gálio (InGaP). Este componente do DEVGENIUS V12 permite a representação de estados do sistema através de milhões de combinações cromáticas. Cada canal (R, G, B) possui controle de intensidade via PWM, permitindo a criação de efeitos visuais dinâmicos, indicadores de erro atmosférico e interfaces de usuário táteis com feedback visual de alta fidelidade.", 
  ...
  { 
    ...
    info: "Uma tela de matriz ativa composta por diodos orgânicos que emitem luz própria. Ao contrário dos LCDs convencionais, este display OLED não necessita de backlight, resultando em pretos absolutos e uma visibilidade impressionante sob luz solar direta. No GENIUS V12, ele é o portal de saída de dados primário, exibindo gráficos de telemetria, logs de depuração e interfaces gráficas ricas com consumo energético minimalista via protocolo I2C.", 
  ...
  { 
    ...
    info: "O guardião do tempo cronológico para o ecossistema V12. Este Real-Time Clock possui um cristal compensado por temperatura (TCXO) que garante um erro de tempo inferior a 2 minutos por ano. Mesmo em caso de falha de energia na placa principal, o DS3231 mantém a contagem de segundos, minutos, horas e datas, permitindo que sistemas GENIUS agendem tarefas críticas com precisão de milissegundos.", 
  ...
  { 
    ...
    info: "A interface de entrada tátil clássica. Com 16 botões organizados em uma malha de linhas e colunas, permite ao usuário GENIUS V12 inserir códigos numéricos, senhas e comandos de configuração. Sua estrutura mecânica de membrana é projetada para durabilidade extrema e economia de pinos I/O do microcontrolador através da técnica de multiplexação.", 
  ...
  { 
    ...
    info: "Identificação por radiofrequência para sistemas de controle de acesso. Este módulo opera em 13.56 MHz e permite ler e escrever dados em tags e cartões RFID. No sistema GENIUS V12, é a solução padrão para segurança de portas e sistemas de inventário inteligente.", 
  ...
  { 
    ...
    info: "Duo de sensores para monitoramento ambiental externo. Detecta a presença de gotas de água em sua superfície ou a condutividade elétrica do solo para determinar a necessidade de irrigação. No kernel V12, este conjunto gerencia jardins inteligentes e telhados retráteis automáticos.", 
  ...
  { 
    ...
    info: "O visor de caracteres alfanuméricos mais versátil. Com o adaptador I2C integrado, utiliza apenas dois pinos do microcontrolador para exibir mensagens, valores de sensores e menus de configuração. Essencial para interfaces de usuário compactas no ecossistema V12.", 
  ...
  },
  {
    ...
    info: "Localização por satélite global de alta sensibilidade. Equipado com uma antena cerâmica integrada, o NEO-6M fornece coordenadas geográficas, altitude e tempo preciso via protocolo NMEA. No ecossistema V12, é o componente chave para navegação de drones e rastreamento de frotas em tempo real.",
  ...
  },
  {
    ...
    info: "Interface de controle de dois eixos e um botão. Proporciona controle preciso para movimentação de robôs e navegação em menus complexos. No GENIUS V12, é utilizado para simulação de direção humana.",
    image: "/img/componentes/_placeholder.svg",
    specs: { voltagem: "5V", pinagem: "5 Pinos", criacao: "Interface Gamer" }
  },
  {
    id: "c18", nome: "Sensor de Chama", tipo: "Normal",
    info: "Detecta radiação infravermelha emitida pelo fogo. Essencial para sistemas de segurança e robôs de combate a incêndio baseados no kernel V12.",
  ...
  },
  {
    ...
    info: "Transdutor piezoelétrico para geração de sons e tons musicais. Utilizado no GENIUS V12 para feedback sonoro e alarmes personalizados via frequências PWM.",
  ...
  },
  {
    ...
    info: "Emissor de laser de baixa potência para sistemas de alarme e mira. No kernel V12, serve para detecção de passagem e barreiras ópticas.",
  ...
  },
  {
    ...
    info: "Detecta impactos mecânicos e vibrações bruscas. No kernel V12, atua como sistema de alarme contra intrusão e monitoramento de integridade estrutural.",
    image: "/img/componentes/_placeholder.svg",
  ...
  },
  {
    ...
    info: "Versão expandida para exibir horas, pontuações e valores decimais. No GENIUS V12, serve como visor secundário de telemetria.",
    image: "/img/componentes/_placeholder.svg",
  ...
  },
  {
    ...
    info: "Detecta vazamentos de GLP, Fumaça e Gás Metano. O pulmão de segurança para ambientes industriais monitorados pelo firmware do ecossistema V12.",
    image: "/img/componentes/_placeholder.svg",
  ...
  },
  {
    ...
    info: "Expansão de memória massiva para logs de dados e arquivos mp3. No ecossistema V12, permite o armazenamento de terabytes de telemetria.",
  ...
  },
  {
    ...
    info: "Monitora a frequência cardíaca em tempo real através de pletismografia óptica. Integra dados de saúde humana diretamente ao kernel V12.",
  ...
  },
  {
    ...
    info: "Estabilizadores de voltagem e filtros de ruído. Garantem que a energia fornecida ao kernel V12 seja limpa e estável.",
  ...
  },
  {
    ...
    info: "A voz do GENIUS V12. Capaz de reproduzir arquivos sonoros reais com alta qualidade diretamente de um cartão micro SD.",
    image: "/img/componentes/_placeholder.svg",
  ...
  },
  {
    ...
    info: "Densidade energética superior para robôs autônomos. Alimenta o sistema Genius V12 em missões remotas fora da rede elétrica.",
  ...
  },
  {
    ...
    info: "Regulador step-down que transforma altas voltagens em energia estável para o kernel V12 com eficiência industrial.",
  ...
  },
  {
    ...
    info: "Componente optoeletrônico básico de 5mm com acabamento difuso para melhor espalhamento da luz azul. Ideal para indicadores de estado e sinalização simples em projetos baseados no kernel V12.",
    image: "/img/componentes/_placeholder.svg",
...
export const DATA_PC_HARDWARE: HardwareItem[] = [
  { 
    ...
    info: "O ápice absoluto do processamento gráfico e computação paralela. Com assombrosos 24GB de VRAM GDDR6X e uma matriz de núcleos Tensor e RT de quarta geração, esta GPU é o motor visual por trás do GENIUS V12. Ela processa trilhas de Ray Tracing em tempo real e acelera modelos de deep learning locais with uma largura de banda que ultrapassa os 1TB/s. No nosso ambiente, é utilizada para renderizar simulações físicas hiper-realistas e interfaces neurais com fidelidade absoluta.", 
  ...
  { 
    ...
    info: "A usina de força que alimenta o GENIUS V12. Com certificação 80 PLUS Titanium, esta fonte garante uma eficiência energética superior a 94%, reduzindo o calor e o ruído elétrico. Possui um painel OLED integrado que exibe o consumo de energia em tempo real, permitindo aos usuários ter controle total sobre a demanda elétrica dos seus sistemas PC Master de alta performance.", 
